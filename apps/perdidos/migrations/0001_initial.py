# Generated by Django 3.1.6 on 2021-02-24 02:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edad', models.CharField(default='Desconocido', max_length=2)),
                ...
                ('otro_dato', models.CharField(default=django.db.models.deletion.SET_NULL, max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Persona',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_evento', models.DateField(default=datetime.datetime(2021, 2, 24, 2, 31, 56, 129557))),
                ...
                ('id_ubicacion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='perdidos.ubicacion')),
                ('id_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='perdidos.persona')),
            ],
        ),
        migrations.CreateModel(
            name='Perdido',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gratificacion', models.CharField(default='Sin gratificación', max_length=5)),
        ...
        migrations.AddField(
            model_name='mascota',
            name='id_dueño',
            field=models.ForeignKey(default=django.db.models.deletion.SET_NULL, on_delete=django.db.models.deletion.CASCADE, to='perdidos.persona'),
        ),
        migrations.CreateModel(
            name='Encontro',
            fields=[
                ...
                ('fecha_limite', models.DateField(default=django.db.models.deletion.SET_NULL, null=True)),
                ('id_publicacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='perdidos.publicacion')),
            ],
        ),
        migrations.CreateModel(
