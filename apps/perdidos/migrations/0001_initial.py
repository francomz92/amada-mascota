    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otro_dato', models.CharField(default=None, max_length=200)),
                ('id_dueño', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Ubicacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_limite', models.DateField(default=None, null=True)),
                ('id_publicacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='perdidos.publicacion')),
            ],
        ),
        migrations.CreateModel(
